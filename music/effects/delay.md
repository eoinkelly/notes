...
-   Types of delay:
    1. Tape delay
        - a rotating tape has one record head and 1+ play heads at configurable distances (delays)
          after the dry sound
        - original delay
        - flat and dull
    ...
    1. Analog (Bucket brigade)
        - based on a then newly released bucket brigade chipsets (basically big chains of
          capacitors)
    ...
    1. Analog controlled by digital
        - Like old-school analog delay but augmented with digital controls of the delay e.g. adds
          tap tempo
    ...
    1. Reverse delay
        ...
        - Like a looper with loops between 1ms - 2000ms (or thereabouts) and plays them back
          reversed and echos
        - Played by
            - Beatles white album
...
-   tape delay was originally used for this
    -   ?? maybe doesn't matter too much what kind of delay you use because it's so short?
...
-   Opinion 4
    ...
    -   Roland SRV-2000 Digital Reverb (set to 'secret' delay mode: hold down Reverb/Non Linear,
        Write and Room Simulate buttons while powering on; Delay Time: 318ms, Feedback: 30, Output:
        50)—used on intro only; for 'stabs' and slide part increase delay time to 425ms and pair
        with an additional SRV-2000 in plate A reverb setting.
...
-   Typically very clean repeats. So clean that you need EQ and filtering to avoid them clashing
