...
1. Boss RE-202
    - Really well reviewed
    - Looks cool a.f.
1. Some good example of digital
...
- Types of delay:
    1. Tape delay
        - a rotating tape has one record head and 1+ play heads at configurable
          distances (delays) after the dry sound
        - original delay
        - flat and dull
    ...
    1. Analog (Bucket brigade)
        - based on a then newly released bucket brigade chipsets (basically big
    ...
    1. Analog controlled by digital
        - Like old-school analog delay but augmented with digital controls of
          the delay e.g. adds tap tempo
    1. Delay + Octaver = "shimmer"
        - repeats can be pitch-shifted
        - invented by Brian Eno (maybe for U2?)
        - Examples
            - EHX Canyon
    1. Reverse delay
        - Sounds really cool I think
        - Like a looper with loops between 1ms - 2000ms (or thereabouts) and
          plays them back reversed and echos
        - Played by
            - Beatles white album
...
- 1983
    ...
    - Roland SDE-3000 released
        ...
        - Boss SDE-3000D is a modern floor pedal reproduction and expansion of
          this
...
- Delay time in time w your playing = delay as a noticeable effect.
    ...
    - Dotted 8th notes to fill in between the notes you actually play is an The
      Edge thing
...
- 80-120, moderate wet mix = slapjack
- tape delay was originally used for this
    - ?? maybe doesn't matter too much what kind of delay you use because it's
      so short?
...
- Opinion 4
    ...
    - Roland SRV-2000 Digital Reverb (set to 'secret' delay mode: hold down
      Reverb/Non Linear, Write and Room Simulate buttons while powering on;
      Delay Time: 318ms, Feedback: 30, Output: 50)—used on intro only; for
      'stabs' and slide part increase delay time to 425ms and pair with an
      additional SRV-2000 in plate A reverb setting.

### Edge Joshua tree

- stereo delay
- he used Korg SDD-3000
- dotted eight in one channel
- quarter note on the other channel
- Q: I guess I'd need a interface with 2 guitar inputs to capture this
- conflicting stuff online about this
    - some say 1 delay, some say 2
    - people agree on the Korg SDD-3000
...
1. Character delays
    ...
    - these were the original digital delays
    - character sometimes imparted by 12 bit processors
    - Examples
        - Boss DD-2
        - Boss DD-3
        - DD-3t adds tap tempo
2. Modelling delays
    - more powerful CPUs that can mimic other kinds of delay
    - came about when processing power got good/cheap enough
    - can mimic all other delays (digital, analog, tape etc.) plus creative
      stuff
    - Examples
        - Line6 DL4
        - Boss DD-500
...
3. Creative delays
    - Out there effects
    - Not really designed for regular playing but for creating specific kinds of
      sounds and ambience
    - Examples
        - Meris Polymoon
...
- the wet signal goes through ADC -> Processing -> Dac -> Mixed w. analog clean
  signal
- Lots of the modern digital and modelling delays

1980's stereo rack delay sounds are the origins
...
- Rack units:
    ...
    - SDE-3000
- You need to run stereo delay to get the most out of these units
...
- These rack digital delays were very popular because they were
    - cleaner than analog
    - analog delay sound was unfashionable when digital first came out
    - had longer delay times than analog

Modern digital delay

- Typically very clean repeats. So clean that you need EQ and filtering to avoid
  them clashing with your clean signal
- Examples
...
- Using 2 delays is common
- Some delay pedals have stereo output
- Sometimes using two delay pedals
- Examples
