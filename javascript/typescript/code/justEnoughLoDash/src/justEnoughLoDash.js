...
var isPresent = function (val) {
  return !(0, exports.isMissing)(val);
};
...
var isSymbol = function (symbolMaybe) {
  return typeof symbolMaybe === 'symbol';
};
...
var isNumberNaN = function (maybeNaN) {
